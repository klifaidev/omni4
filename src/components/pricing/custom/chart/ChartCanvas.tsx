...
function WaterfallChart({
  ...
  }, [wfMode, pvmCfg, comparisonMode, decomposition, topN, budget, budgetSignature, dsRows, dsRowsSignature, block.filters, block.id, block.dataSource, metric, effectiveMeasure, cacheSlideId]);
